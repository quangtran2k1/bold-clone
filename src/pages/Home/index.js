                ...
                <div className={cx('container')}>
                    ...
                    >
                        ...
                        <div className={cx('card_item_content')}>
                            ...
                            <div className={cx('fade_in_on_scroll')}>
                                <p>
                                    Easily integrate with all your favorite tools through and APIs including automatic
                                    integrations.
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        <div className={cx('card_item_content')}>
                            <div className={cx('card_feature_center')}>
                                <div className={cx('fade_in_on_scroll')}>
                                    <img src={images.quickActionIcon} className={cx('card_feature_icon')} alt="icon" />
                                </div>
                                <div className={cx('fade_in_on_scroll')}>
                    ...
                    >
                        <div className={cx('card_item_content')}>
                            <div className={cx('card_feature_center')}>
                                <div className={cx('fade_in_on_scroll')}>
                                    <img src={images.shoppingCartIcon} className={cx('card_feature_icon')} alt="icon" />
                                </div>
                                <div className={cx('fade_in_on_scroll')}>
                                    <h6>Easy shop</h6>
                                </div>
